		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				...
				<form action="{{route('search')}}" method="get" class="wrap-search-header flex-w p-l-15">
					...
					<input class="plh3" type="text" name="query" value="{{ request()->input('query') }}" placeholder="Search...">
				</form>
			</div>
		</div>
	</header>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Call us +7(707) 702 34 23
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This project is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by DNA team
