				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<div class="filter-col1 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6">
									<a href="{{route('home')}}" class="filter-link stext-106 trans-04">
										Default
									</a>
								</li>

								<li class="p-b-6">
									<a href="{{route('homesortupd')}}" class="filter-link stext-106 trans-04">
										Newness
									</a>
								</li>

								<li class="p-b-6">
									<a href="{{route('homesortlow')}}" class="filter-link stext-106 trans-04">
										Price: Low to High
									</a>
								</li>

								<li class="p-b-6">
									<a href="{{route('homesorthigh')}}" class="filter-link stext-106 trans-04">
										Price: High to Low
									</a>
								</li>
							</ul>
