...
@section('content')
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center m-t-80 p-lr-15 p-tb-92" style="background-image: url('images/bg-01.jpg');">
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								DNA center 6th floor, 163a Auezova St, Almaty, 050057 KZ
							</p>
						</div>
					</div>
